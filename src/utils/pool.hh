 ...
 *
 * This header file contains definitions and services auxiliary to the
 * implementation of an optimized storage for expressions. Expressions
 * are stored in a Directed Acyclic Graph (DAG) for data sharing.
 *
