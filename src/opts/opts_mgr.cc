...
namespace opts {
    ...
    {
        if (f_vm.count("reach-fast-forward-strategy")) {
    ...
    {
        if (f_vm.count("reach-forward-strategy")) {
    ...
    {
        if (f_vm.count("reach-fast-backward-strategy")) {
    ...
    {
        if (f_vm.count("reach-backward-strategy")) {
    ...
    {
        if (f_vm.count("sat-clause-decay")) {
    ...
    {
        if (f_vm.count("sat-luby-restart")) {
    ...
    {
        if (f_vm.count("sat-restart-first")) {
    ...
    {
        if (f_vm.count("sat-subsumption-lim")) {
    ...
    {
        if (f_vm.count("sat-simp-garbage-frac")) {
    ...
    {
        if (f_vm.count("cnf-microcode-directory")) {
