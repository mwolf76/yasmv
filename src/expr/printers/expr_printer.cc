...
bool Printer::walk_bits_preorder(const Expr_ptr expr)
{ return true; }
bool Printer::walk_bits_inorder(const Expr_ptr expr)
{ f_os << "("; return true; }
void Printer::walk_bits_postorder(const Expr_ptr expr)
{ f_os << ")"; }
