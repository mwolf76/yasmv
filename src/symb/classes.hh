...
namespace symb {
    ...
    public:
        Constant(const expr::Expr_ptr module,
                 const expr::Expr_ptr name,
                 type::Type_ptr type,
                 value_t value)
            : f_module(module)
            , f_name(name)
    ...
    public:
        Parameter(expr::Expr_ptr module,
                  expr::Expr_ptr name,
                  type::Type_ptr type)
            : f_module(module)
            , f_name(name)
    ...
    public:
        Literal(const expr::Expr_ptr name,
    ...
    public:
        Define(const expr::Expr_ptr module,
               const expr::Expr_ptr name,
               const expr::Expr_ptr body)
            : f_module(module)
            , f_name(name)
            , f_body(body)
        {}
